...
CREATE TABLE IF NOT EXISTS "public"."oneview_new_hire" (
...
CREATE TABLE IF NOT EXISTS "public"."oneview_title_translation" (
"id" int4 NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."oneview_attrition_assumption" (
...
CREATE TABLE IF NOT EXISTS "public"."oneview_roster_summary" (
"capability_id" text NOT NULL,
    "snapshot_week" date,
...
CREATE TABLE IF NOT EXISTS "public"."oneview_budget" (
"capability_id" text NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."cape_chat_messages" (
...
CREATE TABLE IF NOT EXISTS "public"."cape_chat_sessions" (
"id" uuid NOT NULL DEFAULT gen_random_uuid(),
...
CREATE TABLE IF NOT EXISTS "public"."cape_reminders" (
"id" uuid NOT NULL DEFAULT gen_random_uuid(),
    "username" text NOT NULL,
    "text" text NOT NULL,
    "due_at" timestamptz,
    "repeat" text NOT NULL DEFAULT 'none'::text CHECK (repeat = ANY (ARRAY['none'::text, 'daily'::text, 'weekly'::text, 'monthly'::text])),
    "status" text NOT NULL DEFAULT 'active'::text CHECK (status = ANY (ARRAY['active'::text, 'paused'::text, 'done'::text])),
    "delivery_channel" text NOT NULL DEFAULT 'in_app'::text CHECK (delivery_channel = ANY (ARRAY['in_app'::text, 'email'::text])),
    "created_at" timestamptz NOT NULL DEFAULT now(),
    "updated_at" timestamptz NOT NULL DEFAULT now(),
    PRIMARY KEY ("id")
);

CREATE TABLE IF NOT EXISTS "public"."cape_recommendation_thresholds" (
"id" uuid NOT NULL DEFAULT gen_random_uuid(),
    "username" text NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."oneview_hierarchy" (
"cp_plan_id" int4 NOT NULL,
    "capability_id" text,
...
CREATE TABLE IF NOT EXISTS "public"."oneview_shrinkage" (
"cp_plan_id" int4 NOT NULL,
    "capability_id" text,
    "organization" text,
...
CREATE TABLE IF NOT EXISTS "public"."oneview_planner_dataset" (
"cp_plan_id" int4 NOT NULL,
    "capability_id" text,
    "organization" text,
    "business_entity" text,
...
CREATE TABLE IF NOT EXISTS "public"."oneview_header_details" (
"cp_plan_id" int4 NOT NULL,
...
CREATE TABLE IF NOT EXISTS "public"."oneview_roster_work_status" (
...
CREATE TABLE IF NOT EXISTS "public"."oneview_roster_log" (
...
CREATE TABLE IF NOT EXISTS "public"."oneview_roster_role" (
